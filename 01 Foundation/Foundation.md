...
This design uses concrete deck blocks for support with corner piers to hold down the structure during high winds.
...
To avoid major excavation, find a location which is fairly level. You can do this easily by using a _String Line_ tied between two stakes. Once you've found a rough location, attach a _String Line Level_ to the string to gauge how much excavation will be needed.
...
[![](blueprints/A01.svg)](https://github.com/dangnelson/WATERBEAR-Shed/blob/master/01 Foundation/blueprints/A01.pdf)
...
Attach _String Line Levels_ to the strings on all four sides. Level starting roughly an inch above the ground at the highest point. Use this as a guide to remove top soil until the ground is leveled.
...
Rent an 8-12" _Auger_ and use the _Digging Tools_ if you have rocky soil.
...
Nail the sides of the _Cardboard Concrete Form Tubes_ to the center of 2 2x4s. The tube should hang about 12 inches up from the bottom of the footing.

Make sure to wear a _Respiratory Mask_ to avoid breathing in  concrete dust, and _Cleaning Gloves_ to protect your skin for this next step.
...
[![](blueprints/A02.svg)](https://github.com/dangnelson/WATERBEAR-Shed/blob/master/01 Foundation/blueprints/A02.pdf)
...
Cut the _Treated 4x4x8s_ to size and insert them into the _Galvanized Post Bases_

## 5. Joist End Plates

![](images/A04.svg)

Place the end plates temporarily on two _Concrete Deck Blocks_ and use _Shims_ to level them until they all line up with each other at the corners.

Drill the holes for the bolts. Then bolt the 4x4s to the end plates.

[![](blueprints/A04.svg)](https://github.com/dangnelson/WATERBEAR-Shed/blob/master/01 Foundation/blueprints/A04.pdf)
...
Use the _Shovel_ and the _Hoe_ to spread a layer of gravel around the blocks to improve drainage.
...
Load the _Nail Gun_ with _2.5" Nails_.
...
[![](blueprints/A09.svg)](https://github.com/dangnelson/WATERBEAR-Shed/blob/master/01 Foundation/blueprints/A09.pdf)
...
| \[Hoe\]\([https://en.wikipedia.org/wiki/Hoe\_\(tool](https://en.wikipedia.org/wiki/Hoe_%28tool)\)\) | 1 | 15.97 |
...
| \[8" Auger\]\([https://en.wikipedia.org/wiki/Auger\_\(drill](https://en.wikipedia.org/wiki/Auger_%28drill)\)\) | Rent | 50.00 |
